...
{
    std::vector<uint8_t> HMACSHA256::compute(const std::vector<uint8_t> &data, const std::vector<uint8_t> &key)
    {
    ...
    bool HMACSHA256::verify(const std::vector<uint8_t> &data, const std::vector<uint8_t> &key, const std::vector<uint8_t> &expected)
    {
