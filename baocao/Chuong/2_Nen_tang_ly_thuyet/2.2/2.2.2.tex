...
An toàn cấu trúc của RSA phụ thuộc vào tính bất khả thi về mặt tính toán của bài toán phân tích thừa số nguyên tố (Integer Factorization) đối với các số nguyên lớn. Theo thiết kế, khóa công khai được phân phối công khai trên môi trường mạng mà không gây ảnh hưởng đến tính bảo mật của hệ thống, bởi vì chi phí thời gian để nội suy khóa bí mật từ khóa công khai vượt quá khả năng xử lý của các kiến trúc máy tính truyền thống đương đại.
